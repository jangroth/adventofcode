...
class TestChronalCoordinates(TestCase):
    ...
    def test_double_chronal_generator(self):
        ...
        self.assertEqual([(0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 4), (2, 4), (3, 4), (4, 4), (4, 3), (4, 2), (4, 1), (4, 0), (3, 0), (2, 0), (1, 0), (0, 0)], result)
    ...
    def test_fill_matrix(self):
        self.cc.matrix = self.cc._create_empty_matrix(10)
        self.cc.matrix[1][1] = 'A'
